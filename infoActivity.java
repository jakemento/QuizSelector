...
public class infoActivity extends Activity {
    ...
    @Bind(R.id.moreInfoTextView)
    TextView mMoreInfoTextView;
    @Bind(R.id.TapToDismissTextView)
    TextView mTapToDismissTextView;
...
//        int height = dm.heightPixels;
        ...
        mTapToDismissTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                finish();
            }
